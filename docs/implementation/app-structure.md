...
| `/settings/practice`        | `routes/settings/practice/+page.svelte`        | Practice toggle, Lift plans toggle, link to `/goals`                                                                                                 |
...
flowchart TB
    ...
    Settings --> SettingsHab["/settings/habits · baselines · practice · activity · health"]
