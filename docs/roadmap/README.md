...
| Item      | Notes                                                                                                                                        | Spec                         |
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| Baselines | Embarrassingly low daily floors/ceilings + multi-entry logging + per-baseline line charts. Separate from Habits and from Lift plans (v1.9.0) | [baselines.md](baselines.md) |
