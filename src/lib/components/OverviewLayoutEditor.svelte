<!-- Overview card order (Personalization, US-046). Also rendered at /settings/overview. -->
<script lang="ts">
...
>
	...
	<p class="order-hint">
		Drag to reorder, or use the arrows. Cards for features you have turned off keep their place here
		but stay hidden on Overview.
	</p>
